...
function validateForm(e) {
  ...
  if (nameField.value === ""){
    document.getElementById("name-error").innerHTML = "¡Para enviar el siguiente Mensaje, se necesita llenar el siguiente campo!";
  } else {
    showNotification();
  }
}
...
function showNotification() {
  ...
  document.querySelector(".notification").innerHTML= "El mensaje fue enviado con Éxito";
